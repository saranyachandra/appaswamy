						   ...
						   <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
									   ...
									   <form id="blog_form" action="" class="create-user step-form-horizontal" method="POST">
                                            <div class="row"> 
                                                    ...
                                                    <section>                                                    
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="blog_title" class="form-control alpha-only" placeholder="Enter Blog Title" style="text-transform: capitalize;">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
