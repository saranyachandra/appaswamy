						   ...
						   <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h2 class="card-title" style="font-size: 27px;">Create New Features</h2>
									</div>
									<div class="card-body">
									   ...
									   <form id="features_add_form" action="" class="create-user step-form-horizontal" method="POST">
                                            <div class="row"> 
                                        	    <div class="col-lg-6 col-md-6"> 
                                                    <section>                                                    
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="text-label">Features Title</label>
                                                                <input type="text" name="features" class="form-control alpha-only" placeholder="Enter Features" style="text-transform: capitalize;">
                                                            </div>
                                                        </div>                                                                                               
                                                    </section>
                                                </div>
