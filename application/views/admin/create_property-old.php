                                                                        ...
                                                                        <div id="Floor-Plan" class="tab-pane fade">
                                                                            <div class="form-group col-sm-12 " style="font-size: 15px;">
                                                                                ...
                                                                                <select name="eventdayscount" id="btn-add-tab" class="form-control required" style="background-color:#eff0f1;">
                                                                                  ...
                                                                                  <option value="2">Tower B</option>
                                                                                  <option value="3">Tower c</option>
                                                                                  <option value="4">Tower D</option>
                                                                                  <option value="5">Tower E</option>
                                                                                  <option value="6">Tower F</option>
                                                                                  <option value="7">Tower H</option>
                                                                                </select>
                                                                            </div>
