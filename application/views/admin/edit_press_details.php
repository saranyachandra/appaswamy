						   ...
						   <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h2 class="card-title" style="font-size: 27px;">Edit Press</h2>
									</div>
									<div class="card-body">
									   ...
									   <form id="press_edit" action="" class="create-user step-form-horizontal" method="POST" enctype="multipart/form-data">
                                            <div class="row"> 
                                        	    <div class="col-lg-6 col-md-6"> 
                                                    <section> 
                                                        <input type="hidden" name="press_id"  class="form-control" value="<?=  
                                                        $details->press_id ?>">                                                    
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                <label class="text-label">Press Title</label>
                                                                <textarea name="press_title" class="form-control alpha-only" style="text-transform: capitalize;" ><?= $details->title; ?></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <?php 
                                                                  $timestamp = strtotime($details->press_date); 
                                                                  $new_date = date("Y-m-d", $timestamp);
                                                                  
                                                                ?>
                                                                <input type="date" name="press_date"  class="form-control" value="<?php echo $new_date ?>">
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            ...
                                                            <div class="col-lg-6 mb-2">
                                                                <div class="form-group">
                                                                    <img style="width:100px; height: 65px;"  src="<?= base_url('assets/admin/uploads/press/thumb_img/').$details->thumb_img; ?>" >
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div> 
                                                        <div class="col-lg-12 mb-2">
                                                            ...
                                                            <div class="col-lg-6 mb-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" name="pdf_upload_new" class="form-control" accept=" .pdf" >
                                                                    <input type="hidden"  name="pdf_upload" value="<?php echo $details->pdf_file; ?>"  >
                                                                </div>
                                                            </div>
                                                                <?php if($details->pdf_file){ ?>
                                                            <div class="col-lg-6 mb-2">
                                                                <div class="form-group">
                                                                    <a  href="<?= base_url('assets/admin/uploads/press/pdf/').$details->pdf_file; ?>" target="_blank" > PDF File View </a>
                                                                </div>
                                                            </div>
                                                                <?php }?>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="news_url" class="form-control alpha-only" placeholder="Enter News URL" value="<?= $details->news_url; ?>" >
                                                            </div>
                                                        </div>                                                     
                                                    </section>
                                                </div>
                                                    ...
                                                    <section>                                                 
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="press_desc" rows="10" cols="80">
