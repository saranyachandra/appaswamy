						   ...
						   <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h2 class="card-title" style="font-size: 27px;">Create Mobile Banner</h2>
									</div>
									<div class="card-body">
									   ...
									   <form id="mobile_banner_form" action="" name="form-example-1" id="form-example-1" enctype="multipart/form-data" method="POST">
                                            
                                        	    <div class="col-lg-12 col-md-12">
                                                        <div class="row ">
                                                           <div class="col-lg-6 col-md-6 ">
                                                                <label class="text-label">Banner Img1 Upload </label>
                                                                <input type="file"  name="banner_img_1" class="form-control"  accept=".jpg, .jpeg, .png, .webp" onchange="preview_image_1(event)">
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                           <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="file"  name="banner_img_2" class="form-control"  accept=".jpg, .jpeg, .png, .webp" onchange="preview_image_2(event)">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 mb-2">
                                                        ...
                                                        <div class="row">
                                                           <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="file"  name="banner_img_3" class="form-control"  accept=".jpg, .jpeg, .png, .webp" onchange="preview_image_3(event)">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 mb-2">
                                                        ...
                                                        <div class="row">
                                                           <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="file"  name="banner_img_4" class="form-control"  accept=".jpg, .jpeg, .png, .webp" onchange="preview_image_4(event)">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 mb-2">
                                                        ...
                                                        <div class="row ">
                                                           <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="file"  name="banner_img_5" class="form-control"  accept=".jpg, .jpeg, .png, .webp" onchange="preview_image_5(event)">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 mb-2">
